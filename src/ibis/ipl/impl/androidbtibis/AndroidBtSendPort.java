...
final class AndroidBtSendPort extends SendPort implements AndroidBtProtocol {
    ...
    private class Conn extends SendPortConnectionInfo {
        ...
        Conn(AndroidBtSocket s, AndroidBtSendPort port, ReceivePortIdentifier target)
                throws IOException {
            super(port, target);
            this.s = s;
    ...
    AndroidBtSendPort(Ibis ibis, PortType type, String name,
    ...
    protected SendPortConnectionInfo doConnect(ReceivePortIdentifier receiver,
        ...
        AndroidBtSocket s =
                ((AndroidBtIbis) ibis).connect(this, receiver, (int) timeoutMillis,
                        fillTimeout);
