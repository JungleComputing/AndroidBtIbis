...
class AndroidBtReceivePort extends ReceivePort implements AndroidBtProtocol {

    class ConnectionHandler extends ReceivePortConnectionInfo 
            implements Runnable, AndroidBtProtocol {

        private final AndroidBtSocket s;

        ConnectionHandler(SendPortIdentifier origin, AndroidBtSocket s,
    ...
    AndroidBtReceivePort(Ibis ibis, PortType type, String name, MessageUpcall upcall,
    ...
    void connect(SendPortIdentifier origin, AndroidBtSocket s,
